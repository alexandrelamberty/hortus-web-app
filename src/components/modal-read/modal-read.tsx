...
const ModalRead = ({ title, subtitle, onClose }: ModalReadProps) => {
  return (
    <div
      id="readProductModal"
      // tabindex="-1"
    ...
    >
      <div className="relative p-0 w-full  h-full md:h-auto">
        {/* Modal content */}
          ...
          <div>
            <dl>
              ...
              <Dropdown
                label="Filter"
                size="sm"
                onChange={(e: any) => console.log("dropdown change", e.value)}
              >
                <DropdownItem title="Test" key="1" value="1" />
                <DropdownItem title="Test second" key="2" value="2" />
              </Dropdown>
              <Button label="Edit" />
            </dl>
          </div>
